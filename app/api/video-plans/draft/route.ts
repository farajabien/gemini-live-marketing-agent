...
import { adminDb, serverDb, generateId } from "@/lib/firebase-admin";
...
export async function POST(request: NextRequest) {
  try {
    ...
    const { plan, planId, narrativeId, narrativeAngles, sourceContentPieceId } = await request.json();
    ...
    console.error("Error saving draft video plan:", error);
